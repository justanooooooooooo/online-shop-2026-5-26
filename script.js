const products = [
...

  {
    name: "來一客牛肉蔬菜",
    price: 40,
    description: "Beef and vegetable noodles.",
...

  {
    name: "來一客韓式泡菜",
    price: 40,
    description: "Korean kimchi noodles.",
    image: "https://shoptaiwan.us/cdn/shop/products/image_b5427701-c7b-42bd-b4f1-95468500f188_600x600.jpg?v=1661241898"
  },
...
function generateOrderText() {
  ...
  cart.forEach(function(item) {
    ...
    text +=
      `${item.name} | Price: $${item.price} | Quantity: ${item.quantity} | Item Total: $${itemTotal}\n`;
  });
